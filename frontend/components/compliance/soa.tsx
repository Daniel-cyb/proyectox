            ...
            <tr key={idx} className="hover:bg-gray-100 transition duration-200">
              ...
              <td>
                <select
                  ...
                  onChange={(e) => handleFieldChange(document._id, 'Implementado SI / NO', e.target.value)}
              ...
              <td>
                <select
                  ...
                  onChange={(e) => handleFieldChange(document._id, 'Aplica', e.target.value)}
                  className="p-2 border rounded"
                >
                  <option value="">Seleccionar...</option>
                  <option value="Sí">Sí</option>
              ...
              <td>
                <input
                  ...
                  onChange={(e) => handleFieldChange(document._id, 'Justificación de la inclusión o exclusión', e.target.value)}
                  className="p-2 border rounded"
                />
              </td>
              <td>
                <input
                  ...
                  onChange={(e) => handleFieldChange(document._id, 'Soporte/Evidencia', e.target.value)}
                  className="p-2 border rounded"
                />
              </td>
              <td>
