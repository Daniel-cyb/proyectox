"use client"; // Indica que el componente está destinado a ejecutarse en el cliente
...
export default function ListaNegraPage() {
  ...
  // Función para obtener los datos de /api/listas_negras
  useEffect(() => {
  ...
  // Actualiza los resultados filtrados cuando cambien las fechas de inicio o fin
  useEffect(() => {
    handleFilter();
  }, [startDate, endDate]);
  ...
  return (
    <div className="p-6 font-sans bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
      <h1 className="text-center mb-6 text-2xl font-bold">Lista Negra Dashboard</h1>
